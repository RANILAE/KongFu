...
public class YinYangSystem : MonoBehaviour
{
    ...
    private void ApplyBalanceEffect(float yangPoints, float yinPoints)
    {
        ...
        {
            // 玩家恢复5点生命值
            BattleSystem.Instance.playerManager.Heal(5);
            BattleSystem.Instance.uiManager.UpdateBattleLog("Player healed 5 HP!");
        ...
        {
            BattleSystem.Instance.uiManager.UpdateBattleLog("Balance heal effect on cooldown!");
        }
    }
